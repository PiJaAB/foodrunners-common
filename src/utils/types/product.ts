...
import type {
  LevelOfContainmentCodeEnumeration,
  AllergenCodeEnumeration,
  PackagingMarkedLabelAccreditationCodeEnumeration,
  PackageTypeCodeEnumeration,
  PriceComparisonTypeCodeEnumeration,
  PackagingMarkedFreeFromCodeEnumeration,
} from '../enumerations';
import type { Measurement, MeasurementUnits } from './measurements';

type LevelOfContainment = {
