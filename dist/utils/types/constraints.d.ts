...
export declare type Constraints = {
    [key in keyof ConstraintDefs]: {
        [key2 in keyof ConstraintDefs[key] | 'type']: (ConstraintDefs[key] & {
            type: key;
        })[key2];
    };
};
export declare type Constraint = Constraints[keyof Constraints];
export {};
